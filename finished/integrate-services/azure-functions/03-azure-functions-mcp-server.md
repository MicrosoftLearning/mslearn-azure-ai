...
In this section you create a new Azure Functions project in Visual Studio Code using the Azure Functions extension. The extension scaffolds the project structure, generates the *.vscode* configuration files for integrated debugging, and sets up the Python v2 programming model. You also configure the MCP server settings in *host.json*.
...
1. Test the **classify_document** tool by typing the following prompt in the Copilot chat:
...
1. Test the **summarize_text** tool by typing the following prompt in the Copilot chat:
