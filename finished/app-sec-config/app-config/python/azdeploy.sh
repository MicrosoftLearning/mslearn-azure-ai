...
EOF
    ...
    local env_ps1_file="$(dirname "$0")/.env.ps1"

    cat > "$env_ps1_file" << EOF
\$env:AZURE_APPCONFIG_ENDPOINT = "$ac_endpoint"
EOF
    ...
    echo "PowerShell variables saved to: $env_ps1_file"
}
