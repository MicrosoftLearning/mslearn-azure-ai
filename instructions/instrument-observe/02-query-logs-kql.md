...
- Check that both the *.env* and *.env.ps1* files exist in the project root and contain the **APPLICATIONINSIGHTS_CONNECTION_STRING**, **RESOURCE_GROUP**, **APPINSIGHTS_NAME**, **APPINSIGHTS_RESOURCE_ID**, and **ALERT_EMAIL** values.
